...
// ============================================================
// Day 10 Piece 1 - EF Core Tracking vs AsNoTracking
// ============================================================
...
if (app.Environment.IsDevelopment())
{
    app.MapGet(
        ...
        async (QuotesDbContext db) =>
        {
            ...
            var noTrackingAllocated =
                noTrackingEnd - noTrackingStart;
