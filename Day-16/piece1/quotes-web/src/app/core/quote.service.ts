...
export class QuoteService {
  ...
  // POST /api/quotes/ — real QuotesApi endpoint. Requires an authenticated
  // user (.RequireAuthorization(), no specific policy); the user id is
  // derived server-side from the auth token, not sent in the body.
