...
// Stand-in for whatever the guard's returnUrl (or the /quotes default)
// resolves to, so navigateByUrl() after a successful login has somewhere to go.
@Component({ template: '' })
...
describe('Login', () => {
  ...
  beforeEach(async () => {
    ...
    await TestBed.configureTestingModule({
      ...
      providers: [
        ...
        provideRouter([
          { path: 'quotes', component: DummyDestination },
          { path: 'quotes/new', component: DummyDestination },
        ]),
      ],
    }).compileComponents();
  ...
  it('logs in successfully, shows a submitting state, and prevents duplicate submissions', async () => {
    ...
    // With no returnUrl query param, a successful login lands on /quotes.
