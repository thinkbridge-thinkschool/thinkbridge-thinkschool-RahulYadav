...
describe('QuoteDetail', () => {
  ...
  it('shows a fallback state when no route id is bound', async () => {
    const fixture = TestBed.createComponent(QuoteDetail);
    fixture.detectChanges();
    await fixture.whenStable();

    const compiled = fixture.nativeElement as HTMLElement;
    expect(compiled.textContent).toContain('No quote id was provided.');
  });
  ...
  it('shows a friendly message for a non-numeric route id, without calling the API', async () => {
    const fixture = TestBed.createComponent(QuoteDetail);
    ...
    const compiled = fixture.nativeElement as HTMLElement;
    expect(compiled.textContent).toContain('Invalid quote id.');
    httpMock.expectNone(() => true);
  });

  it('shows a friendly message for a negative or zero route id, without calling the API', async () => {
    const fixture = TestBed.createComponent(QuoteDetail);
  ...
  it('does not let a stale response for an earlier selection overwrite a newer one', async () => {
    ...
    // User quickly navigates to a second quote before A's response arrives.
    fixture.componentRef.setInput('id', '2');
    fixture.detectChanges();
    await fixture.whenStable();
