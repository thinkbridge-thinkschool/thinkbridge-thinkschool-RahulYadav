...
internal sealed class FakeQuoteRepository : IQuoteRepository
{
        ...
        CancellationToken cancellationToken)
    {
        ...
        // No real transaction/outbox table backs this fake — it only needs
        // to prove the factory is invoked with the quote's assigned Id,
        // matching QuoteRepository's real ordering.
        buildOutboxMessage(quote);
