    ...
    DateTimeOffset CreatedAtUtc)
{
    ...
    // Shared discriminator string: the Service Bus ApplicationProperties
    // "EventType" value (ServiceBusQuoteEventPublisher), and the Day 20
    // OutboxMessage.EventType value (QuoteEndpointExtensions /
    // OutboxRelayBackgroundService) — one constant instead of three
    // independently-typed literals that could drift apart.
    public const string EventType = "QuoteCreated";
